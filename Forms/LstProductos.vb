...
Public Class LstProductos
    ...
    Private Sub btnBorrar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBorrar.Click
        ...
        Dim respuesta As DialogResult = MessageBox.Show("¿Esta seguro de eliminar el registro:  " & producto.Id.ToString & " ? ", "advertencia", MessageBoxButtons.OKCancel, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button2)
